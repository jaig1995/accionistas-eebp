...
const customPalettes = {
    ...
    eebpblue: generatePalette('#002e5f'),
    eebpgreen: generatePalette('#579c29')
};
...
const themes = {
    ...
    'default': {
        primary  : customPalettes.eebpblue,
        accent   : customPalettes.eebpgreen,
        warn     : {
            ...colors.red,
    ...
    'brand' : {
        primary: customPalettes.eebpgreen
    },
    'teal'  : {
        primary: {
            ...colors.teal,
