...
@Component({
    selector: 'app-endosar-publicacion-modal',
    standalone: true,
    imports: [
        CommonModule,
        MatFormFieldModule,
    ...
    templateUrl: 'endosarPublicacionModal.component.html',
    encapsulation: ViewEncapsulation.None,
})
export class EndosarPublicacionModalComponent {
    ...
    submit() {
        ...
        this.controlTitulosService.endosarTitulo(transaccion).subscribe({
            next:(data)=>{
