...
@Component({
    ...
    templateUrl: 'donacionModal.component.html',
    styleUrls: ['./donacionModal.component.css'],
        ...
        this.controlTitulosService.enviarTransaccion(enviar)
            .subscribe({
                next: (data) => {
                    ...
                    let nombreArchivo = `$transaccion_${conseTrans}_formatoDonacion`
                    this.cambiarNombreArchivo(nombreArchivo)
                    // enviar formato transaccion
