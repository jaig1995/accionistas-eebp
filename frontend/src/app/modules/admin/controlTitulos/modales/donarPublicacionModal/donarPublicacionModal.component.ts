...
@Component({
    selector: 'app-donar-publicacion-modal',
    standalone: true,
    imports: [
        CommonModule,
        MatFormFieldModule,
    ...
    templateUrl: 'donarPublicacionModal.component.html',
    encapsulation: ViewEncapsulation.None,
})
export class DonarPublicacionModalComponent {
    ...
    submit() {
        ...
        this.controlTitulosService.donarTitulo(transaccion).subscribe({
            next: (data) => {
