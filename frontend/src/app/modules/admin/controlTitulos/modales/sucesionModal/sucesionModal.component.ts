...
@Component({
    ...
    templateUrl: 'sucesionModal.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SucesionModalComponent {
        ...
        this.controlTitulosService.enviarTransaccion(enviar)
            .subscribe({
                next: (data) => {
                    ...
                    let nombreArchivo = `transaccion_${conseTrans}_formatoSucesion`
                    this.cambiarNombreArchivo(nombreArchivo)
                    // enviar archivo transaccion
