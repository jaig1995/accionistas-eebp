...
@Component({
    ...
    templateUrl: './ventaModal.component.html',
        ...
        this.controlTitulosService.enviarTransaccion(enviar)
            .subscribe({
                next: (data) => {
                    ...
                    let nombreArchivo = `transaccion_${conseTrans}_formatoVenta`
                    this.cambiarNombreArchivo(nombreArchivo)
                    //enviar documento de la transacción
