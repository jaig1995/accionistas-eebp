...
@Component({
    ...
    templateUrl: 'embargoModal.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EmbargoModalComponent implements OnInit {
        ...
        this.controlTitulosService.enviarTransaccion(enviar)
            .subscribe({
                next: (data) => {
                    ...
                    let nombreArchivo = `${this.idPersona}_transaccion_${conseTrans}_formatoEmbargo`
                    this.cambiarNombreArchivo(nombreArchivo)
                    // enviar formato de la transaccion
